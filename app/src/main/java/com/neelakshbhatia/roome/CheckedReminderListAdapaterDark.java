 ...
 */
 ...
 public class CheckedReminderListAdapaterDark extends ArrayAdapter<CheckedReminderList> implements Checkable {

    public CheckedReminderListAdapaterDark(Context context, ArrayList<CheckedReminderList> x) {
        super(context, 0, x);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if (convertView==null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.reminder_list_item_dark, parent, false);
        }
        // Lookup view for data population
        CheckedTextView reminderListItem = (CheckedTextView) convertView.findViewById(R.id.reminder_list_item2);
